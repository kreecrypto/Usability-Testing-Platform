import { preflightTestTarget, type TestTargetSnapshotV1 } from "./test-target-import.ts";
...
export class PrototypeImportError extends Error {
  code: "invalid_test_id" | "invalid_prototype_url" | "test_not_found" | "permission_denied" | "data_request_failed";
  status: number;

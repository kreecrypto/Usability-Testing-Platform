...
export class TestTargetImportError extends Error {
  readonly code: "invalid_url" | "unsupported_scheme" | "invalid_figma_prototype" | "ownership_confirmation_required" | "preflight_verification_failed";
...
export function approveInternalFirstPartyTarget(
  ...
  if (
    ...
    source.pathname !== INTERNAL_VALIDATION_TARGET_PATH ||
    source.search !== ""
  ) {
    throw new TestTargetImportError("preflight_verification_failed", 409);
  }
  ...
  return Object.freeze({
    ...
    providerConfig: Object.freeze({
      ...
      approvedPath: INTERNAL_VALIDATION_TARGET_PATH,
    }),
  });
}
